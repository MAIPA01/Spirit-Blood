...
public class BasicSpirit : ObjectHealth
{
    ...
    void Update()
    {
        ...
        Vector2 realVelocity = new Vector2(Mathf.Lerp(rigid.velocity.x, desiredVelocity.x, Time.deltaTime * changeDirectionSpeed), Mathf.Lerp(rigid.velocity.y, desiredVelocity.y, Time.deltaTime * changeDirectionSpeed));
